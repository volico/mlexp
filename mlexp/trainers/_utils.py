...
def _save_metric_curves(metric_curves, saved_files_path, trial_number):
    file_name = r'{}/saved_metric_curves/metric_curves_trial_{}.json'.format(saved_files_path, trial_number)
...
def _save_models(models, saved_files_path, trial_number):
    ...
    for fold_num, model in enumerate(models):
        ...
        model_file_path = r'{}/saved_models/model_trial_{}_fold_{}.pickle'.format(saved_files_path,
                                                                                  trial_number, fold_num)
